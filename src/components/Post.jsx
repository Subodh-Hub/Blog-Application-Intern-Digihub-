...
const Post = () => {
  return (
    <main className="w-[392px]  bg-white border-[1px] border-solid border-[#E8E8EA] rounded-xl drop-shadow-sm p-3 dark:bg-[#181A2A] dark:border-gray-700">
      ...
      <div className="w-[360px] h-[200px] m-auto flex flex-col gap-4 mt-5 items-left">
        ...
        <h3 className="text-2xl font-semibold leading-7 cursor-pointer line-clamp-3 ">
